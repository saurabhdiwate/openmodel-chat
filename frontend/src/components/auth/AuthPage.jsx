...
import { LOGO_ICON_NAMES } from "@openmodel/shared";
...
const AuthPage = () => {
  ...
  const LogoIcon = LOGO_ICONS[settings?.logoIcon] || LucideIcons.MessageSquare;
      ...
      <div className="w-full max-w-md">
        <div className="border-theme-surface bg-theme-canvas-alt rounded-lg border p-8 shadow-lg">
          <div className="mb-6 flex flex-col items-center gap-3">
            <div className="bg-theme-primary flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-xl shadow-lg">
              <LogoIcon className="h-6 w-6 text-white" />
            </div>
            <h1 className="text-theme-text text-2xl font-bold">{appName}</h1>
          </div>

          <h2 className="text-theme-text-muted mb-6 text-center text-sm font-medium">
